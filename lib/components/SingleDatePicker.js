    ...
    value: function () {
      function responsivizePickerPosition() {
        ...
        if (!withPortal && !withFullScreenPortal) {
          ...
          this.setState({
            dayPickerContainerStyles: (0, _object2['default'])({}, (0, _getResponsiveContainerStyles2['default'])(anchorDirection, currentOffset, containerRect[anchorDirection], horizontalMargin), appendToBody && (0, _getDetachedContainerStyles2['default'])(openDirection, anchorDirection, this.container))
          });
        }
      }
    ...
    value: function () {
      function renderDayPicker() {
        ...
        return _react2['default'].createElement(
          ...
          }, (0, _reactWithStyles.css)(styles.SingleDatePicker_picker, anchorDirection === _constants.ANCHOR_LEFT && styles.SingleDatePicker_picker__directionLeft, anchorDirection === _constants.ANCHOR_RIGHT && styles.SingleDatePicker_picker__directionRight, anchorDirection === _constants.ANCHOR_CENTER && styles.SingleDatePicker_picker__directionCenter, openDirection === _constants.OPEN_DOWN && styles.SingleDatePicker_picker__openDown, openDirection === _constants.OPEN_UP && styles.SingleDatePicker_picker__openUp, !withAnyPortal && openDirection === _constants.OPEN_DOWN && {
